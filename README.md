...
the turning point fot the field was when CNN(Convolutional Neural Netwroks) was developed but not only that; when also Hardware was capable of Training enormous models while reducong time needed to do so.
complete enhancments to both will lead to more enhancements in our life*
